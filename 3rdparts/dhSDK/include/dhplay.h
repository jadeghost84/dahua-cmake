...
typedef struct _FILE_INFO
{
	...
	BYTE		disk_type;					// Disk type, 0:xxFS; 1:XFS
...
typedef enum _IVS_TYPE
{
	...
	IVSINFOTYPE_DHOP_SMART			= 22,			// open platform smart(0x14)
}IVS_TYPE;
...
typedef enum _STATISTIC_TYPE
{
	...
	VIDEO_PARSE_ERROR,				// Video parsing error£¬parameter 1 means error codes, see PARSE_ERROR_FLAGS for details£¬parameter 2 means frame number
	VIDEO_RENDER_ERROR,				// Video rendering error, parameter 1 lack of meaning, parameter 2 means frame number
	VIDEO_DECODE_SWITCH,			// Video decoding type switch, parameter 1 means decoding type after switch£¬see DecodeType for details£¬parameter 2 lack of meaning
}STATISTIC_TYPE;
